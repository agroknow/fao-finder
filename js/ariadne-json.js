...
//            }
            ...
            //publishing date
            if(data.contributors.length!==undefined)
            {
                jQuery('#publishingDate').append('<span class="forKomma last">'+data.contributors[0].date+'</span>');
            }
            ...
            if(data.contributors.length!==undefined)
                ...
                {
                if(j==data.contributors.length-1){
                        jQuery('#authors').append('<span class="forKomma last">'+data.contributors[j].name+'<span>');
                
                }else{
                    jQuery('#authors').append('<span class="forKomma">'+data.contributors[j].name+'<span>');
